...
urlpatterns = [
    ...
    path("car/<slug:slug>/", views.ViewCarPost.as_view(),
         name="view_car_post"),
    path('like-comment/<int:comment_id>/', views.like_comment,
         name='like_comment'),
    path('like-car-post/<int:car_id>/', views.like_car_post,
         name='like_car_post'),
    path('delete-comment/<int:comment_id>/', views.DeleteCommentView.as_view(),
         name='delete_comment'),
    path('user-posts/<str:username>/', views.UserPostsListView.as_view(),
         name='user_posts'),
